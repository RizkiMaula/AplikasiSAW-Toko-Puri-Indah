...
import static views.Nilai.kdRecruiter;
/**
 *
...
public class Recruiter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Daftar Recruter");
    ...
    public void daftarTransaksi() {
        ...
        daftarBarang.addColumn("No");
        daftarBarang.addColumn("Kode Recruiter");
        daftarBarang.addColumn("Nama Recruiter");
        daftarBarang.addColumn("Alamat");
        daftarBarang.addColumn("Kontak");
        ...
        try {
            ...
            while(rs.next()) {
                daftarBarang.addRow(new Object[]{
                    no++,
                    rs.getString(1),
                    rs.getString(2),
                    rs.getString(3),
            ...
            tabelDaftar.setModel(daftarBarang);
    ...
    private void tabelDaftarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelDaftarMousePressed
        ...
        String recruiter = tabelDaftar.getValueAt(baris, 1).toString();
        kdRecruiter.setText(recruiter);
